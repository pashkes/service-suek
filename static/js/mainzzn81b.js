...
(function () {
  var TABLE_WIDTH = 768;
  var spaceTop = 160;
  var btnMenu = document.querySelector('.js-show-menu');
  var body = document.body;
  var closeBtn = document.querySelector('.js-close-menu');
  var header = document.querySelector('.header__top');

  var onClickCloseMobileMenu = function onClickCloseMobileMenu() {
  ...
  var onClickMobileMenu = function onClickMobileMenu() {
  ...
  var menuIsOpened = function menuIsOpened() {
  ...
  var toggleClassOnScrollHandler = function toggleClassOnScrollHandler() {
    if (window.scrollY > 1) {
  ...
  var toggleClassOnScroll = function toggleClassOnScroll() {
...
(function () {
  var DESKTOP_SCREEN = 1199;
  var WIDTH_TABLET = 767;
  var OFFSET_AFTER_SCROLL_TO_PRODUCT = 150;
  var HEIGHT_ONE_ROW = '424px';
  var MAX_HEIGHT_LIST = "3000px";
  var sliderProducts = $('.js-products-slider');
  var showMoreBtn = $('.js-show-more');
  var productsList = $('.products__slider');
  ...
  var showMoreProducts = function showMoreProducts() {
    showMoreBtn.on('click', function (evt) {
      evt.preventDefault();
      var isPressed = showMoreBtn.attr('aria-pressed');
...
(function () {
  ...
  var stateProductModal = {
    opened: false
  };
  var orderForm = document.querySelector('#order-form');
  var orderModal = $('#order-modal');

  var onSubmitModalForm = function onSubmitModalForm() {
    orderForm.addEventListener('submit', function (evt) {
      evt.preventDefault(); // *important* Should add this code after successfully send form to the server
  ...
  var getModalBodyHeight = function getModalBodyHeight(modal) {
    var modalHeaderHeight = modal.find('.modal__header').innerHeight();
    var modalFooterHeight = modal.find('.modal__footer').innerHeight();
    return viewportHeight - (modalHeaderHeight + modalFooterHeight);
  };

  var recalculateBodyHeightProduct = function recalculateBodyHeightProduct() {
  ...
  var showOrderFormModal = function showOrderFormModal() {
  ...
  productModal.on('shown.bs.modal', function () {
    viewportHeight = $(window).height();
    productModal.find('.modal__body').css('height', getModalBodyHeight(productModal));
    stateProductModal.opened = !stateProductModal.opened; // recalculate width slider after shown modal

    $('.js-modal-slider').slick('setPosition');
  });

  var changeStateProductModal = function changeStateProductModal() {
    productModal.on('hidden.bs.modal', function () {
      stateProductModal.opened = !stateProductModal.opened;
    });
  };

  var showModalForm = function showModalForm() {
    $('.js-open-form-order').on('click', function () {
      productModal.modal('hide');
      productModal.on('hidden.bs.modal', showOrderFormModal);
    });
  };

  var removeListenerOrderForm = function removeListenerOrderForm() {
    orderModal.on('hidden.bs.modal', function () {
